...
public class HabilidadLogic {
    ...
    {
        LOGGER.log(Level.INFO, "Inicia proceso de consultar la habilidad con id = {0} del prestador con id ={1} ",new Long[]{ prestadorId, habilidadId});
    ...
    {
        LOGGER.log(Level.INFO, "Inicia proceso de actualizar la habilidad con id = {0} del prestador con id = {1}" , new Long[]{ prestadorId, habilidadEntity.getId()});
        ...
        LOGGER.log(Level.INFO, "Termina proceso de actualizar la habilidad con id = {0} del prestador con id ={1} ",new Long[]{ prestadorId, habilidadEntity.getId()});
    ...
    {
        LOGGER.log(Level.INFO, "Inicia proceso de borrar la habilidad con id = {0} del prestador con id ={1} ", new Long[]{ prestadorId, habilidadId});
        ...
        LOGGER.log(Level.INFO, "Termina proceso de borrar la habilidad con id = {0} del prestador con id ={1} ", new Long[]{ prestadorId, habilidadId});
