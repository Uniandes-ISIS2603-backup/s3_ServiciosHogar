...
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (123, '10/24', 123456789, 'Carlos Eduardo Robles', 1);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (721, '11/29', 987654321, 'Carlos Eduardo Robles', 1);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (852, '12/25', 654321987, 'Carlos Eduardo Robles', 1);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (123, '10/24', 123456789, 'Daniela Rocha', 2);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (721, '11/29', 987654321, 'Daniela Rocha', 2);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (852, '12/25', 654321987, 'Daniela Rocha', 2);
insert into TarjetaCreditoEntity (codeseguridad, fechavencimiento, numero, titular, cliente_id) values (123, '10/24', 123456789, 'Steven Tarazona', 3);
